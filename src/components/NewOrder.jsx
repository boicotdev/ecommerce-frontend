          ...
          <>
            ...
            <div className="flex flex-col items-center justify-center gap-4 relative">
              ...
              <p className="text-muted-foreground">
                Thank you for your order, {customerName}. We'll be in touch
                soon.
              </p>
            </div>
            <div
              className="inline-block text-center absolute top-2 right-4 rounded-full shadow-lg w-6 font-semibold text-xl"
              onClick={closeModal}
            >
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span>
                              $
                              {(product.price * quantities[productId]).toFixed(
                                2
                              )}
                            </span>
                          </div>

          ...
          <div>
            <div className="bg-white shadow-md rounded-lg p-6 mb-6">
              ...
              <div className="flex flex-col justify-center items-center">
                ...
                <Link className="my-0 mx-auto text-center shadow-md rounded-lg px-6 py-3 bg-green-400 hover:bg-green-500 text-white text-2xl" to="/shop">Ir a comprar <i className="fa fa-shopping-cart"></i></Link>
              </div>
              )}
            </div>
            {
...
function getTotalCheck(items) {
  const total = items.reduce((accum, item) => accum + item.quantity * item.price, 0);
  return total;
}
